<template>
  <div class="content-wrapper bg-background-svetla py-3 px-2 mt-4" :class="getTheme">
    <div class="flex justify-between py-1 px-2 text-xl">
      <p class="text-narandza md:text-2xl lg:hover:cursor-default">Most Popular</p>
    ...
    <div class="w-full flex justify-center">
      <div class="flex justify-around flex-wrap py-6 w-full sm:max-w-extraMonster md:w-14/15   md:max-w-extraLargeMonster lg:max-w-full lg:min-w-full xl:w-full xl:min-w-godzila xl:max-w-extraLargeGodzila">
        ...
        @click="sendToParent(movie.id)">
          ...
          <img :src="'https://image.tmdb.org/t/p/w154' + movie.poster_path + '?api_key=a06cfa7f0853984e8a69e2db2fd1b8fd'" class="rounded mt-2 max-w-full transform group-hover:scale-150 transition duration-700">
